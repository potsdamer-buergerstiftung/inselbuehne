        ...
        <Container maxW="6xl">
          ...
          <Grid columnGap={4} rowGap={12} templateColumns="repeat(12, 1fr)">
            {team.sort(sortByName).map((member) => (
              <GridItem colSpan={{ base: 12, sm: 6, md: 4, lg: 3 }} key={member.name}>
      ...
      <Box as="section" pt="20" pb="40" bg={bg} textAlign="center">
        <Container maxW="3xl">
          ...
          <Text mt="3" fontSize="xl" mb="10">
            Ohne ein persönliches Engagement der Potsdamer Stadtgesellschaft wird eine Belebung der
            Inselbühne ein Traum bleiben. Packen wir’s an – Du bist herzlich willkommen,
            mitzumachen!
          </Text>
          <Link href="/kontakt">
...
AboutUsPage.getLayout = (page) => <Layout title="Über uns">{page}</Layout>
