        ...
        <Box as="section" py="20" bg={bg}>
          <Container centerContent maxW="6xl">
            ...
            >
              ...
              >
                <Text mb="10">
                  Wir benötigen Deine Hilfe, um die Inselbühne zu realisieren.
                  Die positive Resonanz der öffentlichen Hand freut uns, das
                  wird uns sicher helfen. Als Bürgerstiftung setzen wir aber
                  darauf, dass auch die breite Stadtgemeinschaft so eine Idee
                  unterstützt.
                </Text>
                <Text mb="10">
                  Für den provisorischen Spielbetrieb im 2021 benötigen wir rund
                  €50.000. Weitere €80.000 werden wir brauchen, um die derzeit
                  ungenutze Freilichtbühne so zu ertüchtigen, dass sie wieder
                  eine Betriebsgenehmigung erhält.
                </Text>
                <Text>
                  Hier setzen wir auf DICH: Hilf uns mit Deiner Spende!
                  Ermögliche eine pandemie-konforme Bühne für Livemusik,
                  Theaterstücke, Tanzshows, Chorkonzerte. Jeder Euro zählt und
                  kommt zu 100 % dem Projekt Inselbühne zugute!
                </Text>
              </GridItem>
            </Grid>
          </Container>
